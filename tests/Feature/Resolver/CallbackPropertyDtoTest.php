...
use DualMedia\DtoRequestBundle\Tests\Fixture\Dto\CallbackPropertyDto;
...
#[Group('feature')]
#[Group('resolver')]
class CallbackPropertyDtoTest extends KernelTestCase
{
    ...
    public function testCallbackTriggersViolation(): void
    {
        $dto = $this->resolver->resolve(
            CallbackPropertyDto::class,
            new Request(request: [
