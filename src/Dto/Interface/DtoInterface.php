...
namespace DualMedia\DtoRequestBundle\Dto\Interface;
 ...
 * Basic Dto interface.
 *
 * The declaration of __construct() must not contain any required arguments.
 */
interface DtoInterface
{
     ...
     */
    public function getParentDto(): self|null;
